...
const AppLayout = props => {
  ...
  // useLaunches, usePlanets are our hooks
  // Capture the state with hooks
  const planets = usePlanets();
  
  // React components for our AppLayout page
  // Header which allows us to navigate from page to page
  // Centered comes from our components
   // Frame which contains our routes
